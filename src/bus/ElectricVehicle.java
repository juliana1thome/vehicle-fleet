...
public class ElectricVehicle extends Vehicle{
    ...
    // Getters and Setters:
    public Double getFuelConsumed() {return kwPowerConsumed;}
    public void setFuelConsumed(Double energyConsumed) {this.kwPowerConsumed = kwPowerConsumed;}
    ...
    public String toString() {
        return "ElectricVehicle{" +
                ...
                ", energyConsumed=" + kwPowerConsumed +
    ...
    // Functions:
    @Override
    public double getMilePerUnitOfEnergy(){return tripCounter/kwPowerConsumed;}
