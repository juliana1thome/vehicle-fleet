...
public class DataCollection {
    ...
    // Public functions
    public static void add(Vehicle object) {vehicleArrayList.add(object);}
    // public static void add(Vehicle newVehicle){vehicleArrayList.add(newVehicle);}

    public static void remove(Vehicle object) {vehicleArrayList.remove(object);}
    ...
    public static void setListOfVehicle(ArrayList<Vehicle> vehicleArrayList){DataCollection.vehicleArrayList = vehicleArrayList;}
}
